...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rda=(RadioButton)findViewById(R.id.pilihA);
        rdb=(RadioButton)findViewById(R.id.pilihB);
        rdc=(RadioButton)findViewById(R.id.pilihC);
        butNext=(Button)findViewById(R.id.jawab);
        setQuestionView();
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RadioGroup grp=(RadioGroup)findViewById(R.id.jawaban);
